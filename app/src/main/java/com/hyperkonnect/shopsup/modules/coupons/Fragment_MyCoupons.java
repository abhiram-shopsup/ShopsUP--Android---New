 ...
 */
public class Fragment_MyCoupons extends Fragment {
    ...
    public Fragment_MyCoupons() {
    }

    public static Fragment_MyCoupons newInstance() {
        Fragment_MyCoupons staticPagesFragment = new Fragment_MyCoupons();
